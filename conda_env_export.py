...
def main():
    ...
    print(
        "Warning: this output might contain packages installed from non-public sources, e.g. a Git repository. "  # noqa
        "You should review and test the output to make sure it works with `conda env create -f`, "  # noqa
        "and make changes as required.\n"
        "For example, `conda-env-export` itself is not currently uploaded to PyPI, and it must be removed from "  # noqa
